...
Latest snapshot: **1,686 nodes tracked**, **1,263 active**, **1,241** of those with a responding API. Those 1,241 span **215 autonomous systems**, and **138** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
