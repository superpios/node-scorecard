...
Latest snapshot: **1,700 nodes tracked**, **1,261 active**, **1,235** of those with a responding API. Those 1,235 span **215 autonomous systems**, and **134** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
