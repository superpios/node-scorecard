...
Latest snapshot: **1,645 nodes tracked**, **1,262 active**, **1,238** of those with a responding API. Those 1,238 span **213 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
