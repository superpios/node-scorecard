...
Latest snapshot: **1,685 nodes tracked**, **1,310 active**, **1,271** of those with a responding API. Those 1,271 span **220 autonomous systems**, and **168** (13.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
