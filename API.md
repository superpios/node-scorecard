...
Latest snapshot: **1,649 nodes tracked**, **1,271 active**, **1,241** of those with a responding API. Those 1,241 span **216 autonomous systems**, and **131** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
