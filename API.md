...
Latest snapshot: **1,819 nodes tracked**, **1,527 active**, **1,486** of those with a responding API. Those 1,486 span **241 autonomous systems**, and **175** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
