...
Latest snapshot: **1,680 nodes tracked**, **1,261 active**, **1,238** of those with a responding API. Those 1,238 span **215 autonomous systems**, and **137** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
