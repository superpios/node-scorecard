...
Latest snapshot: **1,765 nodes tracked**, **1,314 active**, **1,289** of those with a responding API. Those 1,289 span **219 autonomous systems**, and **146** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
