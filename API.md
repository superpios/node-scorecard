...
Latest snapshot: **1,692 nodes tracked**, **1,259 active**, **1,232** of those with a responding API. Those 1,232 span **211 autonomous systems**, and **135** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
