...
Latest snapshot: **1,725 nodes tracked**, **1,313 active**, **1,287** of those with a responding API. Those 1,287 span **222 autonomous systems**, and **145** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
