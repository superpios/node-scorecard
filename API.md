...
Latest snapshot: **1,693 nodes tracked**, **1,258 active**, **1,228** of those with a responding API. Those 1,228 span **214 autonomous systems**, and **138** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
