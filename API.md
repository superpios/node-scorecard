...
Latest snapshot: **1,688 nodes tracked**, **1,314 active**, **1,280** of those with a responding API. Those 1,280 span **218 autonomous systems**, and **169** (13.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
