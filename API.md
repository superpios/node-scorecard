...
Latest snapshot: **1,810 nodes tracked**, **1,496 active**, **1,472** of those with a responding API. Those 1,472 span **230 autonomous systems**, and **175** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
