...
Latest snapshot: **1,818 nodes tracked**, **1,501 active**, **1,481** of those with a responding API. Those 1,481 span **236 autonomous systems**, and **171** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
