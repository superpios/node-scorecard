...
Latest snapshot: **1,727 nodes tracked**, **1,314 active**, **1,284** of those with a responding API. Those 1,284 span **222 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
