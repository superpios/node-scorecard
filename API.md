...
Latest snapshot: **1,722 nodes tracked**, **1,271 active**, **1,246** of those with a responding API. Those 1,246 span **215 autonomous systems**, and **130** (10.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
