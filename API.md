...
Latest snapshot: **1,723 nodes tracked**, **1,261 active**, **1,232** of those with a responding API. Those 1,232 span **215 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
