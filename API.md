...
Latest snapshot: **1,693 nodes tracked**, **1,254 active**, **1,227** of those with a responding API. Those 1,227 span **212 autonomous systems**, and **136** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
