...
Latest snapshot: **1,765 nodes tracked**, **1,305 active**, **1,283** of those with a responding API. Those 1,283 span **218 autonomous systems**, and **139** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
