...
Latest snapshot: **1,720 nodes tracked**, **1,264 active**, **1,234** of those with a responding API. Those 1,234 span **214 autonomous systems**, and **132** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
