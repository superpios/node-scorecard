...
Latest snapshot: **1,809 nodes tracked**, **1,464 active**, **1,434** of those with a responding API. Those 1,434 span **229 autonomous systems**, and **172** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
