...
Latest snapshot: **1,736 nodes tracked**, **1,306 active**, **1,282** of those with a responding API. Those 1,282 span **220 autonomous systems**, and **147** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
