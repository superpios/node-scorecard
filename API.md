...
Latest snapshot: **1,679 nodes tracked**, **1,253 active**, **1,207** of those with a responding API. Those 1,207 span **215 autonomous systems**, and **132** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
