...
Latest snapshot: **1,736 nodes tracked**, **1,310 active**, **1,284** of those with a responding API. Those 1,284 span **220 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
