...
Latest snapshot: **1,830 nodes tracked**, **1,494 active**, **1,466** of those with a responding API. Those 1,466 span **243 autonomous systems**, and **173** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
