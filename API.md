...
Latest snapshot: **1,560 nodes tracked**, **1,316 active**, **1,288** of those with a responding API. Those 1,288 span **219 autonomous systems**, and **167** (13.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
