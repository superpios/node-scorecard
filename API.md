...
Latest snapshot: **1,734 nodes tracked**, **1,313 active**, **1,289** of those with a responding API. Those 1,289 span **220 autonomous systems**, and **148** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
