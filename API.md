...
Latest snapshot: **1,835 nodes tracked**, **1,027 active**, **1,012** of those with a responding API. Those 1,012 span **202 autonomous systems**, and **119** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
