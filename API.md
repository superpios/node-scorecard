...
Latest snapshot: **1,698 nodes tracked**, **1,260 active**, **1,236** of those with a responding API. Those 1,236 span **214 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
