...
Latest snapshot: **1,831 nodes tracked**, **1,514 active**, **1,491** of those with a responding API. Those 1,491 span **242 autonomous systems**, and **179** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
