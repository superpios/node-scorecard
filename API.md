...
Latest snapshot: **1,716 nodes tracked**, **1,265 active**, **1,242** of those with a responding API. Those 1,242 span **217 autonomous systems**, and **135** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
