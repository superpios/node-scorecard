...
Latest snapshot: **1,809 nodes tracked**, **1,492 active**, **1,458** of those with a responding API. Those 1,458 span **230 autonomous systems**, and **169** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
