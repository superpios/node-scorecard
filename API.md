...
Latest snapshot: **1,576 nodes tracked**, **1,327 active**, **1,298** of those with a responding API. Those 1,298 span **222 autonomous systems**, and **171** (13.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
