...
Latest snapshot: **1,773 nodes tracked**, **1,305 active**, **1,285** of those with a responding API. Those 1,285 span **220 autonomous systems**, and **142** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
