...
Latest snapshot: **1,728 nodes tracked**, **1,290 active**, **1,267** of those with a responding API. Those 1,267 span **217 autonomous systems**, and **133** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
