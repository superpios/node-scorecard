...
Latest snapshot: **1,812 nodes tracked**, **1,469 active**, **1,449** of those with a responding API. Those 1,449 span **233 autonomous systems**, and **154** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
