...
Latest snapshot: **1,831 nodes tracked**, **1,467 active**, **1,438** of those with a responding API. Those 1,438 span **234 autonomous systems**, and **153** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
