...
Latest snapshot: **1,679 nodes tracked**, **1,253 active**, **1,225** of those with a responding API. Those 1,225 span **214 autonomous systems**, and **132** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
