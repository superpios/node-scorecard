...
Latest snapshot: **1,686 nodes tracked**, **1,257 active**, **1,227** of those with a responding API. Those 1,227 span **212 autonomous systems**, and **135** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
