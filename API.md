...
Latest snapshot: **1,811 nodes tracked**, **1,466 active**, **1,440** of those with a responding API. Those 1,440 span **230 autonomous systems**, and **173** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
