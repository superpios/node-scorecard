...
Latest snapshot: **1,686 nodes tracked**, **1,262 active**, **1,237** of those with a responding API. Those 1,237 span **215 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
