...
Latest snapshot: **1,808 nodes tracked**, **1,492 active**, **1,462** of those with a responding API. Those 1,462 span **229 autonomous systems**, and **169** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
