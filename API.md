...
Latest snapshot: **1,692 nodes tracked**, **1,259 active**, **1,234** of those with a responding API. Those 1,234 span **214 autonomous systems**, and **138** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
