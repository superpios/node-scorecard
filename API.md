...
Latest snapshot: **1,819 nodes tracked**, **1,468 active**, **1,443** of those with a responding API. Those 1,443 span **231 autonomous systems**, and **157** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
