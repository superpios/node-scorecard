...
Latest snapshot: **1,654 nodes tracked**, **1,259 active**, **1,228** of those with a responding API. Those 1,228 span **215 autonomous systems**, and **131** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
