...
Latest snapshot: **1,729 nodes tracked**, **1,316 active**, **1,291** of those with a responding API. Those 1,291 span **223 autonomous systems**, and **150** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
