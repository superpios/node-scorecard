...
Latest snapshot: **1,673 nodes tracked**, **1,305 active**, **1,273** of those with a responding API. Those 1,273 span **221 autonomous systems**, and **158** (12.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
