...
Latest snapshot: **1,764 nodes tracked**, **1,312 active**, **1,265** of those with a responding API. Those 1,265 span **218 autonomous systems**, and **146** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
