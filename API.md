...
Latest snapshot: **1,709 nodes tracked**, **1,257 active**, **1,231** of those with a responding API. Those 1,231 span **219 autonomous systems**, and **134** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
