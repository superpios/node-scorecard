...
Latest snapshot: **1,844 nodes tracked**, **1,047 active**, **1,024** of those with a responding API. Those 1,024 span **208 autonomous systems**, and **121** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
