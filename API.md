...
Latest snapshot: **1,844 nodes tracked**, **1,054 active**, **1,035** of those with a responding API. Those 1,035 span **205 autonomous systems**, and **117** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
