...
Latest snapshot: **1,657 nodes tracked**, **1,258 active**, **1,226** of those with a responding API. Those 1,226 span **213 autonomous systems**, and **130** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
