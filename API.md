...
Latest snapshot: **1,821 nodes tracked**, **1,442 active**, **1,418** of those with a responding API. Those 1,418 span **231 autonomous systems**, and **153** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
