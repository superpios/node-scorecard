...
Latest snapshot: **1,693 nodes tracked**, **1,256 active**, **1,216** of those with a responding API. Those 1,216 span **210 autonomous systems**, and **138** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
