...
Latest snapshot: **1,701 nodes tracked**, **1,261 active**, **1,236** of those with a responding API. Those 1,236 span **216 autonomous systems**, and **134** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
