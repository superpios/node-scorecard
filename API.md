...
Latest snapshot: **1,665 nodes tracked**, **1,282 active**, **1,251** of those with a responding API. Those 1,251 span **219 autonomous systems**, and **147** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
