...
Latest snapshot: **1,809 nodes tracked**, **1,463 active**, **1,440** of those with a responding API. Those 1,440 span **232 autonomous systems**, and **157** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
