...
Latest snapshot: **1,697 nodes tracked**, **1,259 active**, **1,233** of those with a responding API. Those 1,233 span **214 autonomous systems**, and **133** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
