...
Latest snapshot: **1,686 nodes tracked**, **1,263 active**, **1,237** of those with a responding API. Those 1,237 span **214 autonomous systems**, and **138** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
