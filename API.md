...
Latest snapshot: **1,830 nodes tracked**, **1,468 active**, **1,425** of those with a responding API. Those 1,425 span **235 autonomous systems**, and **156** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
