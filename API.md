...
Latest snapshot: **1,831 nodes tracked**, **1,520 active**, **1,495** of those with a responding API. Those 1,495 span **245 autonomous systems**, and **178** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
