...
Latest snapshot: **1,716 nodes tracked**, **1,265 active**, **1,234** of those with a responding API. Those 1,234 span **216 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
