...
Latest snapshot: **1,705 nodes tracked**, **1,256 active**, **1,233** of those with a responding API. Those 1,233 span **215 autonomous systems**, and **133** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
