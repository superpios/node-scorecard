...
Latest snapshot: **1,828 nodes tracked**, **1,517 active**, **1,495** of those with a responding API. Those 1,495 span **245 autonomous systems**, and **177** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
