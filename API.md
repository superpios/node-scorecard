...
Latest snapshot: **1,574 nodes tracked**, **1,327 active**, **1,300** of those with a responding API. Those 1,300 span **219 autonomous systems**, and **167** (12.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
