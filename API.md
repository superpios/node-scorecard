...
Latest snapshot: **1,665 nodes tracked**, **1,294 active**, **1,266** of those with a responding API. Those 1,266 span **221 autonomous systems**, and **153** (12.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
