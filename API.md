...
Latest snapshot: **1,684 nodes tracked**, **1,260 active**, **1,233** of those with a responding API. Those 1,233 span **216 autonomous systems**, and **128** (10.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
