...
Latest snapshot: **1,686 nodes tracked**, **1,255 active**, **1,220** of those with a responding API. Those 1,220 span **213 autonomous systems**, and **134** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
