...
Latest snapshot: **1,826 nodes tracked**, **1,032 active**, **1,011** of those with a responding API. Those 1,011 span **199 autonomous systems**, and **115** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
