...
Latest snapshot: **1,562 nodes tracked**, **1,317 active**, **1,275** of those with a responding API. Those 1,275 span **217 autonomous systems**, and **167** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
