...
Latest snapshot: **1,668 nodes tracked**, **1,237 active**, **1,212** of those with a responding API. Those 1,212 span **213 autonomous systems**, and **138** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
