...
Latest snapshot: **1,684 nodes tracked**, **1,261 active**, **1,233** of those with a responding API. Those 1,233 span **215 autonomous systems**, and **127** (10.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
