...
Latest snapshot: **1,728 nodes tracked**, **1,308 active**, **1,287** of those with a responding API. Those 1,287 span **223 autonomous systems**, and **146** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
