...
Latest snapshot: **1,670 nodes tracked**, **1,236 active**, **1,214** of those with a responding API. Those 1,214 span **215 autonomous systems**, and **138** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
