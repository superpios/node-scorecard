...
Latest snapshot: **1,809 nodes tracked**, **1,494 active**, **1,475** of those with a responding API. Those 1,475 span **234 autonomous systems**, and **166** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
