...
Latest snapshot: **1,717 nodes tracked**, **1,267 active**, **1,245** of those with a responding API. Those 1,245 span **216 autonomous systems**, and **136** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
