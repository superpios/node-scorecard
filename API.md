...
Latest snapshot: **1,777 nodes tracked**, **1,312 active**, **1,293** of those with a responding API. Those 1,293 span **220 autonomous systems**, and **142** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
