...
Latest snapshot: **1,698 nodes tracked**, **1,261 active**, **1,231** of those with a responding API. Those 1,231 span **213 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
