...
Latest snapshot: **1,645 nodes tracked**, **1,263 active**, **1,239** of those with a responding API. Those 1,239 span **214 autonomous systems**, and **135** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
