...
Latest snapshot: **1,714 nodes tracked**, **1,255 active**, **1,232** of those with a responding API. Those 1,232 span **217 autonomous systems**, and **134** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
