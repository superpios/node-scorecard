...
Latest snapshot: **1,776 nodes tracked**, **1,305 active**, **1,255** of those with a responding API. Those 1,255 span **216 autonomous systems**, and **141** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
