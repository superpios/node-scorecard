...
Latest snapshot: **1,763 nodes tracked**, **1,318 active**, **1,297** of those with a responding API. Those 1,297 span **220 autonomous systems**, and **148** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
