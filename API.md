...
Latest snapshot: **1,654 nodes tracked**, **1,254 active**, **1,227** of those with a responding API. Those 1,227 span **216 autonomous systems**, and **127** (10.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
