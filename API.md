...
Latest snapshot: **1,649 nodes tracked**, **1,272 active**, **1,243** of those with a responding API. Those 1,243 span **216 autonomous systems**, and **133** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
