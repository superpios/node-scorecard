...
Latest snapshot: **1,560 nodes tracked**, **1,316 active**, **1,284** of those with a responding API. Those 1,284 span **218 autonomous systems**, and **168** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
