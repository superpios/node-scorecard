...
Latest snapshot: **1,649 nodes tracked**, **1,277 active**, **1,246** of those with a responding API. Those 1,246 span **216 autonomous systems**, and **133** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
