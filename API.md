...
Latest snapshot: **1,819 nodes tracked**, **1,496 active**, **1,472** of those with a responding API. Those 1,472 span **236 autonomous systems**, and **178** (12.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
