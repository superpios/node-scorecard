...
Latest snapshot: **1,808 nodes tracked**, **1,497 active**, **1,478** of those with a responding API. Those 1,478 span **232 autonomous systems**, and **170** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
