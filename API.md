...
Latest snapshot: **1,723 nodes tracked**, **1,286 active**, **1,265** of those with a responding API. Those 1,265 span **215 autonomous systems**, and **135** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
