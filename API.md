...
Latest snapshot: **1,776 nodes tracked**, **1,309 active**, **1,286** of those with a responding API. Those 1,286 span **220 autonomous systems**, and **141** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
