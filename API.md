...
Latest snapshot: **1,755 nodes tracked**, **1,316 active**, **1,290** of those with a responding API. Those 1,290 span **219 autonomous systems**, and **143** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
