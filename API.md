...
Latest snapshot: **1,680 nodes tracked**, **1,254 active**, **1,226** of those with a responding API. Those 1,226 span **214 autonomous systems**, and **129** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
