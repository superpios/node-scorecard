...
Latest snapshot: **1,828 nodes tracked**, **1,044 active**, **1,021** of those with a responding API. Those 1,021 span **200 autonomous systems**, and **102** (10.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
