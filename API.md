...
Latest snapshot: **1,755 nodes tracked**, **1,317 active**, **1,296** of those with a responding API. Those 1,296 span **220 autonomous systems**, and **148** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
