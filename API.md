...
Latest snapshot: **1,730 nodes tracked**, **1,304 active**, **1,281** of those with a responding API. Those 1,281 span **221 autonomous systems**, and **144** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
