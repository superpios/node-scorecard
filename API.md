...
Latest snapshot: **1,668 nodes tracked**, **1,236 active**, **1,211** of those with a responding API. Those 1,211 span **214 autonomous systems**, and **139** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
