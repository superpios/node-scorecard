...
Latest snapshot: **1,826 nodes tracked**, **1,029 active**, **1,011** of those with a responding API. Those 1,011 span **203 autonomous systems**, and **109** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
