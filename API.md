...
Latest snapshot: **1,819 nodes tracked**, **1,478 active**, **1,439** of those with a responding API. Those 1,439 span **236 autonomous systems**, and **157** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
