...
Latest snapshot: **1,669 nodes tracked**, **1,237 active**, **1,214** of those with a responding API. Those 1,214 span **214 autonomous systems**, and **139** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
