...
Latest snapshot: **1,727 nodes tracked**, **1,287 active**, **1,265** of those with a responding API. Those 1,265 span **218 autonomous systems**, and **136** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
