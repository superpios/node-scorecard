...
Latest snapshot: **1,743 nodes tracked**, **1,306 active**, **1,279** of those with a responding API. Those 1,279 span **220 autonomous systems**, and **148** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
