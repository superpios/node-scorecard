...
Latest snapshot: **1,679 nodes tracked**, **1,257 active**, **1,233** of those with a responding API. Those 1,233 span **214 autonomous systems**, and **137** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
