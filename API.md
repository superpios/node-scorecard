...
Latest snapshot: **1,832 nodes tracked**, **1,331 active**, **1,300** of those with a responding API. Those 1,300 span **227 autonomous systems**, and **146** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
