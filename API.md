...
Latest snapshot: **1,698 nodes tracked**, **1,259 active**, **1,237** of those with a responding API. Those 1,237 span **215 autonomous systems**, and **135** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
