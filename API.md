...
Latest snapshot: **1,693 nodes tracked**, **1,254 active**, **1,231** of those with a responding API. Those 1,231 span **213 autonomous systems**, and **137** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
