...
Latest snapshot: **1,653 nodes tracked**, **1,255 active**, **1,227** of those with a responding API. Those 1,227 span **215 autonomous systems**, and **130** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
