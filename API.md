...
Latest snapshot: **1,809 nodes tracked**, **1,493 active**, **1,474** of those with a responding API. Those 1,474 span **232 autonomous systems**, and **167** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
