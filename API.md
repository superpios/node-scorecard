...
Latest snapshot: **1,832 nodes tracked**, **1,493 active**, **1,468** of those with a responding API. Those 1,468 span **243 autonomous systems**, and **176** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
