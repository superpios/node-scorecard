...
Latest snapshot: **1,659 nodes tracked**, **1,279 active**, **1,251** of those with a responding API. Those 1,251 span **219 autonomous systems**, and **140** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
