...
Latest snapshot: **1,722 nodes tracked**, **1,266 active**, **1,239** of those with a responding API. Those 1,239 span **216 autonomous systems**, and **132** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
