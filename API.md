...
Latest snapshot: **1,665 nodes tracked**, **1,293 active**, **1,263** of those with a responding API. Those 1,263 span **218 autonomous systems**, and **151** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
