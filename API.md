...
Latest snapshot: **1,809 nodes tracked**, **1,494 active**, **1,469** of those with a responding API. Those 1,469 span **231 autonomous systems**, and **169** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
