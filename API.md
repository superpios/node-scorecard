...
Latest snapshot: **1,817 nodes tracked**, **1,502 active**, **1,469** of those with a responding API. Those 1,469 span **235 autonomous systems**, and **178** (12.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
