...
Latest snapshot: **1,575 nodes tracked**, **1,329 active**, **1,268** of those with a responding API. Those 1,268 span **221 autonomous systems**, and **164** (12.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
