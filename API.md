...
Latest snapshot: **1,839 nodes tracked**, **1,017 active**, **1,003** of those with a responding API. Those 1,003 span **201 autonomous systems**, and **117** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
