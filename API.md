...
Latest snapshot: **1,818 nodes tracked**, **1,498 active**, **1,478** of those with a responding API. Those 1,478 span **236 autonomous systems**, and **169** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
