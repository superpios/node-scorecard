...
Latest snapshot: **1,826 nodes tracked**, **1,022 active**, **1,006** of those with a responding API. Those 1,006 span **198 autonomous systems**, and **108** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
