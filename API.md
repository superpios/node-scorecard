...
Latest snapshot: **1,679 nodes tracked**, **1,255 active**, **1,229** of those with a responding API. Those 1,229 span **216 autonomous systems**, and **133** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
