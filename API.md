...
Latest snapshot: **1,730 nodes tracked**, **1,312 active**, **1,285** of those with a responding API. Those 1,285 span **221 autonomous systems**, and **145** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
