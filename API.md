...
Latest snapshot: **1,698 nodes tracked**, **1,260 active**, **1,232** of those with a responding API. Those 1,232 span **213 autonomous systems**, and **135** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
