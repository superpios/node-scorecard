...
Latest snapshot: **1,773 nodes tracked**, **1,307 active**, **1,283** of those with a responding API. Those 1,283 span **221 autonomous systems**, and **141** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
