...
Latest snapshot: **1,692 nodes tracked**, **1,263 active**, **1,233** of those with a responding API. Those 1,233 span **214 autonomous systems**, and **134** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
