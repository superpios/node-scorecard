...
Latest snapshot: **1,704 nodes tracked**, **1,261 active**, **1,237** of those with a responding API. Those 1,237 span **215 autonomous systems**, and **133** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
