...
Latest snapshot: **1,673 nodes tracked**, **1,304 active**, **1,276** of those with a responding API. Those 1,276 span **222 autonomous systems**, and **159** (12.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
