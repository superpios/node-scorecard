...
Latest snapshot: **1,704 nodes tracked**, **1,258 active**, **1,228** of those with a responding API. Those 1,228 span **217 autonomous systems**, and **136** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
