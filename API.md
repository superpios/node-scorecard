...
Latest snapshot: **1,723 nodes tracked**, **1,296 active**, **1,269** of those with a responding API. Those 1,269 span **215 autonomous systems**, and **133** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
