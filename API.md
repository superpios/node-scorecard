...
Latest snapshot: **1,666 nodes tracked**, **1,288 active**, **1,259** of those with a responding API. Those 1,259 span **219 autonomous systems**, and **150** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
