...
Latest snapshot: **1,725 nodes tracked**, **1,317 active**, **1,289** of those with a responding API. Those 1,289 span **222 autonomous systems**, and **144** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
