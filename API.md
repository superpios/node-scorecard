...
Latest snapshot: **1,728 nodes tracked**, **1,310 active**, **1,286** of those with a responding API. Those 1,286 span **223 autonomous systems**, and **145** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
