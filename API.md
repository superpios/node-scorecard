...
Latest snapshot: **1,648 nodes tracked**, **1,278 active**, **1,242** of those with a responding API. Those 1,242 span **216 autonomous systems**, and **133** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
