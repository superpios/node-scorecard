...
Latest snapshot: **1,704 nodes tracked**, **1,261 active**, **1,237** of those with a responding API. Those 1,237 span **216 autonomous systems**, and **135** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
