...
Latest snapshot: **1,711 nodes tracked**, **1,262 active**, **1,241** of those with a responding API. Those 1,241 span **219 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
