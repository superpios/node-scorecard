...
Latest snapshot: **1,682 nodes tracked**, **1,248 active**, **1,218** of those with a responding API. Those 1,218 span **213 autonomous systems**, and **129** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
