...
Latest snapshot: **1,564 nodes tracked**, **1,322 active**, **1,291** of those with a responding API. Those 1,291 span **220 autonomous systems**, and **166** (12.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
