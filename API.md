...
Latest snapshot: **1,575 nodes tracked**, **1,327 active**, **1,299** of those with a responding API. Those 1,299 span **223 autonomous systems**, and **170** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
