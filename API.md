...
Latest snapshot: **1,726 nodes tracked**, **1,314 active**, **1,286** of those with a responding API. Those 1,286 span **223 autonomous systems**, and **146** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
