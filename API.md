...
Latest snapshot: **1,728 nodes tracked**, **1,290 active**, **1,259** of those with a responding API. Those 1,259 span **218 autonomous systems**, and **134** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
