...
Latest snapshot: **1,809 nodes tracked**, **1,494 active**, **1,472** of those with a responding API. Those 1,472 span **231 autonomous systems**, and **167** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
