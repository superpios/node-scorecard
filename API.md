...
Latest snapshot: **1,718 nodes tracked**, **1,267 active**, **1,242** of those with a responding API. Those 1,242 span **215 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
