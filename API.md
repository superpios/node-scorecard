...
Latest snapshot: **1,728 nodes tracked**, **1,310 active**, **1,277** of those with a responding API. Those 1,277 span **222 autonomous systems**, and **144** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
