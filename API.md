...
Latest snapshot: **1,725 nodes tracked**, **1,313 active**, **1,290** of those with a responding API. Those 1,290 span **222 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
