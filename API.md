...
Latest snapshot: **1,757 nodes tracked**, **1,316 active**, **1,294** of those with a responding API. Those 1,294 span **220 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
