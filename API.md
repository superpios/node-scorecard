...
Latest snapshot: **1,829 nodes tracked**, **1,460 active**, **1,436** of those with a responding API. Those 1,436 span **230 autonomous systems**, and **154** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
