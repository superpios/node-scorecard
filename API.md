...
Latest snapshot: **1,763 nodes tracked**, **1,317 active**, **1,287** of those with a responding API. Those 1,287 span **219 autonomous systems**, and **146** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
