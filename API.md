...
Latest snapshot: **1,680 nodes tracked**, **1,262 active**, **1,239** of those with a responding API. Those 1,239 span **217 autonomous systems**, and **138** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
