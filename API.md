...
Latest snapshot: **1,714 nodes tracked**, **1,259 active**, **1,230** of those with a responding API. Those 1,230 span **217 autonomous systems**, and **133** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
