...
Latest snapshot: **1,741 nodes tracked**, **1,312 active**, **1,287** of those with a responding API. Those 1,287 span **221 autonomous systems**, and **143** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
