...
Latest snapshot: **1,652 nodes tracked**, **1,279 active**, **1,248** of those with a responding API. Those 1,248 span **219 autonomous systems**, and **133** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
