...
Latest snapshot: **1,765 nodes tracked**, **1,313 active**, **1,290** of those with a responding API. Those 1,290 span **218 autonomous systems**, and **145** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
