...
Latest snapshot: **1,665 nodes tracked**, **1,293 active**, **1,267** of those with a responding API. Those 1,267 span **221 autonomous systems**, and **152** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
