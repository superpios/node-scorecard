...
Latest snapshot: **1,679 nodes tracked**, **1,250 active**, **1,217** of those with a responding API. Those 1,217 span **215 autonomous systems**, and **132** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
