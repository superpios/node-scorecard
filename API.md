...
Latest snapshot: **1,698 nodes tracked**, **1,259 active**, **1,232** of those with a responding API. Those 1,232 span **214 autonomous systems**, and **137** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
