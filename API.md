...
Latest snapshot: **1,837 nodes tracked**, **1,476 active**, **1,454** of those with a responding API. Those 1,454 span **238 autonomous systems**, and **157** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
