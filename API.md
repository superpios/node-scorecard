...
Latest snapshot: **1,833 nodes tracked**, **1,446 active**, **1,423** of those with a responding API. Those 1,423 span **236 autonomous systems**, and **155** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
