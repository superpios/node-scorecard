...
Latest snapshot: **1,698 nodes tracked**, **1,257 active**, **1,233** of those with a responding API. Those 1,233 span **213 autonomous systems**, and **138** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
