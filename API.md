...
Latest snapshot: **1,731 nodes tracked**, **1,313 active**, **1,291** of those with a responding API. Those 1,291 span **222 autonomous systems**, and **150** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
