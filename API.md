...
Latest snapshot: **1,699 nodes tracked**, **1,261 active**, **1,236** of those with a responding API. Those 1,236 span **215 autonomous systems**, and **135** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
