...
Latest snapshot: **1,777 nodes tracked**, **1,308 active**, **1,288** of those with a responding API. Those 1,288 span **220 autonomous systems**, and **143** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
