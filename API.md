...
Latest snapshot: **1,826 nodes tracked**, **1,461 active**, **1,436** of those with a responding API. Those 1,436 span **231 autonomous systems**, and **153** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
