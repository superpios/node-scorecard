...
Latest snapshot: **1,755 nodes tracked**, **1,318 active**, **1,292** of those with a responding API. Those 1,292 span **219 autonomous systems**, and **148** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
