...
Latest snapshot: **1,670 nodes tracked**, **1,259 active**, **1,211** of those with a responding API. Those 1,211 span **215 autonomous systems**, and **138** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
