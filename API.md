...
Latest snapshot: **1,739 nodes tracked**, **1,310 active**, **1,289** of those with a responding API. Those 1,289 span **219 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
