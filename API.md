...
Latest snapshot: **1,810 nodes tracked**, **1,497 active**, **1,475** of those with a responding API. Those 1,475 span **228 autonomous systems**, and **175** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
