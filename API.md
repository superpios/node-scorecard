...
Latest snapshot: **1,648 nodes tracked**, **1,279 active**, **1,242** of those with a responding API. Those 1,242 span **216 autonomous systems**, and **132** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
