...
Latest snapshot: **1,653 nodes tracked**, **1,260 active**, **1,231** of those with a responding API. Those 1,231 span **216 autonomous systems**, and **131** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
