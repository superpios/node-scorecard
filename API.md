...
Latest snapshot: **1,828 nodes tracked**, **1,528 active**, **1,502** of those with a responding API. Those 1,502 span **244 autonomous systems**, and **176** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
