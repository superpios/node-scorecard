...
Latest snapshot: **1,776 nodes tracked**, **1,305 active**, **1,283** of those with a responding API. Those 1,283 span **219 autonomous systems**, and **140** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
