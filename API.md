...
Latest snapshot: **1,829 nodes tracked**, **1,460 active**, **1,438** of those with a responding API. Those 1,438 span **231 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
