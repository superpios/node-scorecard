...
Latest snapshot: **1,772 nodes tracked**, **1,305 active**, **1,286** of those with a responding API. Those 1,286 span **220 autonomous systems**, and **142** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
