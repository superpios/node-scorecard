...
Latest snapshot: **1,831 nodes tracked**, **1,507 active**, **1,486** of those with a responding API. Those 1,486 span **241 autonomous systems**, and **177** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
