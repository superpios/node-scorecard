...
Latest snapshot: **1,679 nodes tracked**, **1,253 active**, **1,224** of those with a responding API. Those 1,224 span **215 autonomous systems**, and **133** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
