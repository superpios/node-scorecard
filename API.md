...
Latest snapshot: **1,654 nodes tracked**, **1,254 active**, **1,225** of those with a responding API. Those 1,225 span **213 autonomous systems**, and **129** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
