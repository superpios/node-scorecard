...
Latest snapshot: **1,832 nodes tracked**, **1,027 active**, **1,012** of those with a responding API. Those 1,012 span **196 autonomous systems**, and **115** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
