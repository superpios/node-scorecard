...
Latest snapshot: **1,574 nodes tracked**, **1,328 active**, **1,298** of those with a responding API. Those 1,298 span **221 autonomous systems**, and **164** (12.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
