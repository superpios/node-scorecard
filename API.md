...
Latest snapshot: **1,831 nodes tracked**, **1,311 active**, **1,291** of those with a responding API. Those 1,291 span **221 autonomous systems**, and **143** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
