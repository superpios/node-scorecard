...
Latest snapshot: **1,809 nodes tracked**, **1,492 active**, **1,469** of those with a responding API. Those 1,469 span **232 autonomous systems**, and **167** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
