...
Latest snapshot: **1,777 nodes tracked**, **1,308 active**, **1,285** of those with a responding API. Those 1,285 span **218 autonomous systems**, and **140** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
