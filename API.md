...
Latest snapshot: **1,765 nodes tracked**, **1,315 active**, **1,291** of those with a responding API. Those 1,291 span **219 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
