...
Latest snapshot: **1,722 nodes tracked**, **1,311 active**, **1,292** of those with a responding API. Those 1,292 span **221 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
