...
Latest snapshot: **1,833 nodes tracked**, **1,482 active**, **1,455** of those with a responding API. Those 1,455 span **235 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
