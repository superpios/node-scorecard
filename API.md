...
Latest snapshot: **1,678 nodes tracked**, **1,252 active**, **1,228** of those with a responding API. Those 1,228 span **216 autonomous systems**, and **132** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
