...
Latest snapshot: **1,678 nodes tracked**, **1,250 active**, **1,224** of those with a responding API. Those 1,224 span **213 autonomous systems**, and **130** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
