...
Latest snapshot: **1,686 nodes tracked**, **1,260 active**, **1,233** of those with a responding API. Those 1,233 span **213 autonomous systems**, and **135** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
