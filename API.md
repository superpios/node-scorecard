...
Latest snapshot: **1,666 nodes tracked**, **1,253 active**, **1,225** of those with a responding API. Those 1,225 span **211 autonomous systems**, and **126** (10.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
