...
Latest snapshot: **1,722 nodes tracked**, **1,269 active**, **1,243** of those with a responding API. Those 1,243 span **214 autonomous systems**, and **130** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
