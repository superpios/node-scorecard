...
Latest snapshot: **1,830 nodes tracked**, **1,493 active**, **1,462** of those with a responding API. Those 1,462 span **241 autonomous systems**, and **174** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
