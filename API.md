...
Latest snapshot: **1,718 nodes tracked**, **1,265 active**, **1,240** of those with a responding API. Those 1,240 span **215 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
