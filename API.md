...
Latest snapshot: **1,809 nodes tracked**, **1,493 active**, **1,466** of those with a responding API. Those 1,466 span **231 autonomous systems**, and **168** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
