...
Latest snapshot: **1,723 nodes tracked**, **1,287 active**, **1,263** of those with a responding API. Those 1,263 span **216 autonomous systems**, and **135** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
