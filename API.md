...
Latest snapshot: **1,818 nodes tracked**, **1,493 active**, **1,470** of those with a responding API. Those 1,470 span **237 autonomous systems**, and **177** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
