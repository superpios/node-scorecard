...
Latest snapshot: **1,765 nodes tracked**, **1,304 active**, **1,283** of those with a responding API. Those 1,283 span **218 autonomous systems**, and **141** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
