...
Latest snapshot: **1,830 nodes tracked**, **1,468 active**, **1,423** of those with a responding API. Those 1,423 span **234 autonomous systems**, and **158** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
