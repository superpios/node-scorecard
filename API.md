...
Latest snapshot: **1,576 nodes tracked**, **1,322 active**, **1,294** of those with a responding API. Those 1,294 span **225 autonomous systems**, and **170** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
