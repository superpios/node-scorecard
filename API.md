...
Latest snapshot: **1,734 nodes tracked**, **1,308 active**, **1,285** of those with a responding API. Those 1,285 span **221 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
