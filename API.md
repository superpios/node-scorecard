...
Latest snapshot: **1,673 nodes tracked**, **1,299 active**, **1,270** of those with a responding API. Those 1,270 span **221 autonomous systems**, and **159** (12.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
