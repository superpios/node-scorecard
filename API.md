...
Latest snapshot: **1,668 nodes tracked**, **1,236 active**, **1,207** of those with a responding API. Those 1,207 span **212 autonomous systems**, and **138** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
