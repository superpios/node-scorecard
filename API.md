...
Latest snapshot: **1,828 nodes tracked**, **1,527 active**, **1,501** of those with a responding API. Those 1,501 span **247 autonomous systems**, and **175** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
