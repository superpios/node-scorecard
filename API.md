...
Latest snapshot: **1,817 nodes tracked**, **1,494 active**, **1,469** of those with a responding API. Those 1,469 span **236 autonomous systems**, and **177** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
