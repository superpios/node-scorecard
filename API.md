...
Latest snapshot: **1,574 nodes tracked**, **1,324 active**, **1,300** of those with a responding API. Those 1,300 span **220 autonomous systems**, and **167** (12.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
