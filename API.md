...
Latest snapshot: **1,692 nodes tracked**, **1,258 active**, **1,236** of those with a responding API. Those 1,236 span **215 autonomous systems**, and **138** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
