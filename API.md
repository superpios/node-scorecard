...
Latest snapshot: **1,773 nodes tracked**, **1,306 active**, **1,284** of those with a responding API. Those 1,284 span **220 autonomous systems**, and **141** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
