...
Latest snapshot: **1,678 nodes tracked**, **1,256 active**, **1,226** of those with a responding API. Those 1,226 span **215 autonomous systems**, and **132** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
