...
Latest snapshot: **1,809 nodes tracked**, **1,495 active**, **1,465** of those with a responding API. Those 1,465 span **231 autonomous systems**, and **170** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
