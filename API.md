...
Latest snapshot: **1,673 nodes tracked**, **1,302 active**, **1,268** of those with a responding API. Those 1,268 span **221 autonomous systems**, and **156** (12.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
