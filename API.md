...
Latest snapshot: **1,728 nodes tracked**, **1,293 active**, **1,270** of those with a responding API. Those 1,270 span **218 autonomous systems**, and **136** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
