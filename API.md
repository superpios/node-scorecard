...
Latest snapshot: **1,686 nodes tracked**, **1,256 active**, **1,227** of those with a responding API. Those 1,227 span **213 autonomous systems**, and **134** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
