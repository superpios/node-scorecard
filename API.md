...
Latest snapshot: **1,844 nodes tracked**, **1,045 active**, **1,027** of those with a responding API. Those 1,027 span **207 autonomous systems**, and **109** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
