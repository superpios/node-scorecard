...
Latest snapshot: **1,803 nodes tracked**, **1,490 active**, **1,465** of those with a responding API. Those 1,465 span **230 autonomous systems**, and **165** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
