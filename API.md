...
Latest snapshot: **1,710 nodes tracked**, **1,259 active**, **1,234** of those with a responding API. Those 1,234 span **219 autonomous systems**, and **133** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
