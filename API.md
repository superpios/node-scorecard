...
Latest snapshot: **1,824 nodes tracked**, **1,461 active**, **1,441** of those with a responding API. Those 1,441 span **232 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
