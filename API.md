...
Latest snapshot: **1,722 nodes tracked**, **1,312 active**, **1,287** of those with a responding API. Those 1,287 span **220 autonomous systems**, and **147** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
