...
Latest snapshot: **1,669 nodes tracked**, **1,237 active**, **1,211** of those with a responding API. Those 1,211 span **212 autonomous systems**, and **137** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
