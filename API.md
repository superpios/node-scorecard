...
Latest snapshot: **1,692 nodes tracked**, **1,256 active**, **1,226** of those with a responding API. Those 1,226 span **211 autonomous systems**, and **130** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
