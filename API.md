...
Latest snapshot: **1,809 nodes tracked**, **1,495 active**, **1,473** of those with a responding API. Those 1,473 span **231 autonomous systems**, and **170** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
