...
Latest snapshot: **1,755 nodes tracked**, **1,318 active**, **1,295** of those with a responding API. Those 1,295 span **220 autonomous systems**, and **146** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
