...
Latest snapshot: **1,692 nodes tracked**, **1,255 active**, **1,229** of those with a responding API. Those 1,229 span **211 autonomous systems**, and **132** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
