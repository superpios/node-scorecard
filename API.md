...
Latest snapshot: **1,832 nodes tracked**, **1,313 active**, **1,290** of those with a responding API. Those 1,290 span **222 autonomous systems**, and **143** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
