...
Latest snapshot: **1,810 nodes tracked**, **1,455 active**, **1,434** of those with a responding API. Those 1,434 span **230 autonomous systems**, and **157** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
