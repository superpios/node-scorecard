...
Latest snapshot: **1,807 nodes tracked**, **1,486 active**, **1,465** of those with a responding API. Those 1,465 span **231 autonomous systems**, and **167** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
