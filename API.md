...
Latest snapshot: **1,693 nodes tracked**, **1,256 active**, **1,229** of those with a responding API. Those 1,229 span **211 autonomous systems**, and **138** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
