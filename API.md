...
Latest snapshot: **1,648 nodes tracked**, **1,281 active**, **1,244** of those with a responding API. Those 1,244 span **216 autonomous systems**, and **131** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
