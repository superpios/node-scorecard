...
Latest snapshot: **1,831 nodes tracked**, **1,312 active**, **1,293** of those with a responding API. Those 1,293 span **222 autonomous systems**, and **143** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
