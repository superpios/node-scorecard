...
Latest snapshot: **1,648 nodes tracked**, **1,281 active**, **1,247** of those with a responding API. Those 1,247 span **217 autonomous systems**, and **132** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
