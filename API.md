...
Latest snapshot: **1,666 nodes tracked**, **1,289 active**, **1,258** of those with a responding API. Those 1,258 span **220 autonomous systems**, and **149** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
