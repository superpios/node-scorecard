...
Latest snapshot: **1,818 nodes tracked**, **1,491 active**, **1,468** of those with a responding API. Those 1,468 span **237 autonomous systems**, and **177** (12.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
