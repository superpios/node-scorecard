...
Latest snapshot: **1,654 nodes tracked**, **1,262 active**, **1,231** of those with a responding API. Those 1,231 span **218 autonomous systems**, and **136** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
