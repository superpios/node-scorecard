...
Latest snapshot: **1,709 nodes tracked**, **1,261 active**, **1,238** of those with a responding API. Those 1,238 span **219 autonomous systems**, and **134** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
