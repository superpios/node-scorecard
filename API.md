...
Latest snapshot: **1,679 nodes tracked**, **1,253 active**, **1,228** of those with a responding API. Those 1,228 span **214 autonomous systems**, and **131** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
