...
Latest snapshot: **1,727 nodes tracked**, **1,287 active**, **1,262** of those with a responding API. Those 1,262 span **218 autonomous systems**, and **135** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
