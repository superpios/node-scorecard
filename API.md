...
Latest snapshot: **1,811 nodes tracked**, **1,466 active**, **1,438** of those with a responding API. Those 1,438 span **230 autonomous systems**, and **170** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
