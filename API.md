...
Latest snapshot: **1,735 nodes tracked**, **1,310 active**, **1,283** of those with a responding API. Those 1,283 span **221 autonomous systems**, and **147** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
