...
Latest snapshot: **1,680 nodes tracked**, **1,259 active**, **1,231** of those with a responding API. Those 1,231 span **214 autonomous systems**, and **130** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
