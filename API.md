...
Latest snapshot: **1,867 nodes tracked**, **947 active**, **938** of those with a responding API. Those 938 span **181 autonomous systems**, and **94** (10.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
