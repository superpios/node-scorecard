...
Latest snapshot: **1,728 nodes tracked**, **1,289 active**, **1,263** of those with a responding API. Those 1,263 span **217 autonomous systems**, and **134** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
