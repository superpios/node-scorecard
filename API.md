...
Latest snapshot: **1,819 nodes tracked**, **1,496 active**, **1,472** of those with a responding API. Those 1,472 span **238 autonomous systems**, and **177** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
