...
Latest snapshot: **1,809 nodes tracked**, **1,493 active**, **1,470** of those with a responding API. Those 1,470 span **232 autonomous systems**, and **168** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
