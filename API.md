...
Latest snapshot: **1,673 nodes tracked**, **1,303 active**, **1,273** of those with a responding API. Those 1,273 span **220 autonomous systems**, and **159** (12.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
