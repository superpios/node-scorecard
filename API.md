...
Latest snapshot: **1,721 nodes tracked**, **1,274 active**, **1,232** of those with a responding API. Those 1,232 span **213 autonomous systems**, and **128** (10.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
