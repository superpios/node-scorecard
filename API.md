...
Latest snapshot: **1,839 nodes tracked**, **1,046 active**, **1,000** of those with a responding API. Those 1,000 span **196 autonomous systems**, and **107** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
