...
Latest snapshot: **1,709 nodes tracked**, **1,268 active**, **1,211** of those with a responding API. Those 1,211 span **217 autonomous systems**, and **132** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
