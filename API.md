...
Latest snapshot: **1,717 nodes tracked**, **1,268 active**, **1,241** of those with a responding API. Those 1,241 span **216 autonomous systems**, and **135** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
