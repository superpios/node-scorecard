...
Latest snapshot: **1,673 nodes tracked**, **1,301 active**, **1,272** of those with a responding API. Those 1,272 span **222 autonomous systems**, and **157** (12.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
