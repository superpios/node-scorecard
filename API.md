...
Latest snapshot: **1,679 nodes tracked**, **1,254 active**, **1,230** of those with a responding API. Those 1,230 span **212 autonomous systems**, and **137** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
