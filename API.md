...
Latest snapshot: **1,648 nodes tracked**, **1,273 active**, **1,241** of those with a responding API. Those 1,241 span **217 autonomous systems**, and **133** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
