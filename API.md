...
Latest snapshot: **1,736 nodes tracked**, **1,305 active**, **1,281** of those with a responding API. Those 1,281 span **220 autonomous systems**, and **148** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
