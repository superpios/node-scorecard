...
Latest snapshot: **1,739 nodes tracked**, **1,313 active**, **1,289** of those with a responding API. Those 1,289 span **222 autonomous systems**, and **146** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
