...
Latest snapshot: **1,657 nodes tracked**, **1,271 active**, **1,241** of those with a responding API. Those 1,241 span **213 autonomous systems**, and **130** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
