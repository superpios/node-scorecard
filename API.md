...
Latest snapshot: **1,809 nodes tracked**, **1,480 active**, **1,461** of those with a responding API. Those 1,461 span **232 autonomous systems**, and **170** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
