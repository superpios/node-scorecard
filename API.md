...
Latest snapshot: **1,730 nodes tracked**, **1,305 active**, **1,280** of those with a responding API. Those 1,280 span **222 autonomous systems**, and **146** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
