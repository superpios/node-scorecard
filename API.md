...
Latest snapshot: **1,872 nodes tracked**, **566 active**, **559** of those with a responding API. Those 559 span **136 autonomous systems**, and **54** (9.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
