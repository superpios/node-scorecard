...
Latest snapshot: **1,811 nodes tracked**, **1,466 active**, **1,446** of those with a responding API. Those 1,446 span **233 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
