...
Latest snapshot: **1,685 nodes tracked**, **1,310 active**, **1,280** of those with a responding API. Those 1,280 span **221 autonomous systems**, and **168** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
