...
Latest snapshot: **1,818 nodes tracked**, **1,486 active**, **1,467** of those with a responding API. Those 1,467 span **236 autonomous systems**, and **171** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
