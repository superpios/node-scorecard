...
Latest snapshot: **1,649 nodes tracked**, **1,270 active**, **1,236** of those with a responding API. Those 1,236 span **217 autonomous systems**, and **132** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
