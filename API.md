...
Latest snapshot: **1,693 nodes tracked**, **1,257 active**, **1,233** of those with a responding API. Those 1,233 span **214 autonomous systems**, and **139** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
