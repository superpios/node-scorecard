...
Latest snapshot: **1,678 nodes tracked**, **1,252 active**, **1,225** of those with a responding API. Those 1,225 span **214 autonomous systems**, and **131** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
