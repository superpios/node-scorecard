...
Latest snapshot: **1,678 nodes tracked**, **1,245 active**, **1,219** of those with a responding API. Those 1,219 span **209 autonomous systems**, and **129** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
