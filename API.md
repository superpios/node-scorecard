...
Latest snapshot: **1,663 nodes tracked**, **1,260 active**, **1,238** of those with a responding API. Those 1,238 span **213 autonomous systems**, and **134** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
