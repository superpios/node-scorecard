...
Latest snapshot: **1,684 nodes tracked**, **1,320 active**, **1,282** of those with a responding API. Those 1,282 span **220 autonomous systems**, and **171** (13.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
