...
Latest snapshot: **1,839 nodes tracked**, **1,023 active**, **1,007** of those with a responding API. Those 1,007 span **199 autonomous systems**, and **114** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
