...
Latest snapshot: **1,832 nodes tracked**, **1,513 active**, **1,489** of those with a responding API. Those 1,489 span **243 autonomous systems**, and **179** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
