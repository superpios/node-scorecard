...
Latest snapshot: **1,833 nodes tracked**, **1,444 active**, **1,417** of those with a responding API. Those 1,417 span **234 autonomous systems**, and **154** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
