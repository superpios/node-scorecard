...
Latest snapshot: **1,765 nodes tracked**, **1,305 active**, **1,282** of those with a responding API. Those 1,282 span **217 autonomous systems**, and **141** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
