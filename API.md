...
Latest snapshot: **1,727 nodes tracked**, **1,287 active**, **1,257** of those with a responding API. Those 1,257 span **218 autonomous systems**, and **133** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
