...
Latest snapshot: **1,872 nodes tracked**, **585 active**, **578** of those with a responding API. Those 578 span **142 autonomous systems**, and **55** (9.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
