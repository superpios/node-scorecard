...
Latest snapshot: **1,680 nodes tracked**, **1,256 active**, **1,228** of those with a responding API. Those 1,228 span **210 autonomous systems**, and **133** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
