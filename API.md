...
Latest snapshot: **1,718 nodes tracked**, **1,267 active**, **1,243** of those with a responding API. Those 1,243 span **217 autonomous systems**, and **136** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
