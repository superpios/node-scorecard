...
Latest snapshot: **1,654 nodes tracked**, **1,255 active**, **1,229** of those with a responding API. Those 1,229 span **217 autonomous systems**, and **128** (10.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
