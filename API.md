...
Latest snapshot: **1,665 nodes tracked**, **1,283 active**, **1,251** of those with a responding API. Those 1,251 span **217 autonomous systems**, and **146** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
