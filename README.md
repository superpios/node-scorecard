...
Latest snapshot: **1,821 nodes tracked**, **1,465 active**, **1,444** of those with a responding API. Those 1,444 span **234 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
