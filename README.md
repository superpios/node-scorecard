...
Latest snapshot: **1,821 nodes tracked**, **1,473 active**, **1,450** of those with a responding API. Those 1,450 span **235 autonomous systems**, and **160** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
