...
Latest snapshot: **1,825 nodes tracked**, **1,465 active**, **1,448** of those with a responding API. Those 1,448 span **233 autonomous systems**, and **157** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
