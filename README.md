...
Latest snapshot: **1,809 nodes tracked**, **1,497 active**, **1,477** of those with a responding API. Those 1,477 span **233 autonomous systems**, and **170** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
