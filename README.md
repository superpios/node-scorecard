...
Latest snapshot: **1,830 nodes tracked**, **1,524 active**, **1,499** of those with a responding API. Those 1,499 span **247 autonomous systems**, and **177** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
