...
Latest snapshot: **1,594 nodes tracked**, **1,335 active**, **1,302** of those with a responding API. Those 1,302 span **225 autonomous systems**, and **174** (13.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
