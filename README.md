...
Latest snapshot: **1,593 nodes tracked**, **1,331 active**, **1,301** of those with a responding API. Those 1,301 span **224 autonomous systems**, and **172** (13.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
