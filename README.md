...
Latest snapshot: **2,342 nodes tracked**, **1,731 active**, **1,698** of those with a responding API. Those 1,698 span **229 autonomous systems**, and **178** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
