...
Latest snapshot: **1,635 nodes tracked**, **1,373 active**, **1,339** of those with a responding API. Those 1,339 span **228 autonomous systems**, and **173** (12.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
