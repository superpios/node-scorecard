...
Latest snapshot: **1,818 nodes tracked**, **1,489 active**, **1,469** of those with a responding API. Those 1,469 span **238 autonomous systems**, and **176** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
