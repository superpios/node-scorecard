...
Latest snapshot: **2,238 nodes tracked**, **1,666 active**, **1,633** of those with a responding API. Those 1,633 span **229 autonomous systems**, and **173** (10.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
