...
Latest snapshot: **1,818 nodes tracked**, **1,506 active**, **1,486** of those with a responding API. Those 1,486 span **238 autonomous systems**, and **172** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
