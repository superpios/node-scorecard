...
Latest snapshot: **2,342 nodes tracked**, **1,728 active**, **1,689** of those with a responding API. Those 1,689 span **232 autonomous systems**, and **177** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
