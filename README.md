...
Latest snapshot: **1,833 nodes tracked**, **1,515 active**, **1,491** of those with a responding API. Those 1,491 span **242 autonomous systems**, and **176** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
