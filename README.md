...
Latest snapshot: **1,621 nodes tracked**, **1,364 active**, **1,340** of those with a responding API. Those 1,340 span **228 autonomous systems**, and **174** (13.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
