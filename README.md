...
Latest snapshot: **2,108 nodes tracked**, **1,568 active**, **1,533** of those with a responding API. Those 1,533 span **230 autonomous systems**, and **170** (11.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
