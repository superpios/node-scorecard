...
Latest snapshot: **1,594 nodes tracked**, **1,333 active**, **1,302** of those with a responding API. Those 1,302 span **223 autonomous systems**, and **172** (13.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
