...
Latest snapshot: **1,824 nodes tracked**, **1,461 active**, **1,440** of those with a responding API. Those 1,440 span **241 autonomous systems**, and **177** (12.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
