...
Latest snapshot: **1,817 nodes tracked**, **1,549 active**, **1,519** of those with a responding API. Those 1,519 span **226 autonomous systems**, and **175** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
