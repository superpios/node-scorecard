...
Latest snapshot: **1,613 nodes tracked**, **1,355 active**, **1,328** of those with a responding API. Those 1,328 span **225 autonomous systems**, and **172** (13.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
