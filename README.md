...
Latest snapshot: **1,620 nodes tracked**, **1,368 active**, **1,339** of those with a responding API. Those 1,339 span **229 autonomous systems**, and **171** (12.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
