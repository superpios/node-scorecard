...
Latest snapshot: **1,585 nodes tracked**, **1,322 active**, **1,289** of those with a responding API. Those 1,289 span **223 autonomous systems**, and **169** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
