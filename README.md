...
Latest snapshot: **1,812 nodes tracked**, **1,470 active**, **1,449** of those with a responding API. Those 1,449 span **233 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
