...
Latest snapshot: **2,344 nodes tracked**, **1,732 active**, **1,695** of those with a responding API. Those 1,695 span **231 autonomous systems**, and **174** (10.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
