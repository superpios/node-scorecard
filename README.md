...
Latest snapshot: **1,618 nodes tracked**, **1,358 active**, **1,327** of those with a responding API. Those 1,327 span **224 autonomous systems**, and **170** (12.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
