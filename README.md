...
Latest snapshot: **1,812 nodes tracked**, **1,461 active**, **1,438** of those with a responding API. Those 1,438 span **231 autonomous systems**, and **155** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
