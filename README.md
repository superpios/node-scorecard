...
Latest snapshot: **1,825 nodes tracked**, **1,463 active**, **1,443** of those with a responding API. Those 1,443 span **234 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
