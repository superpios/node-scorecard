...
Latest snapshot: **1,830 nodes tracked**, **1,471 active**, **1,430** of those with a responding API. Those 1,430 span **236 autonomous systems**, and **157** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
