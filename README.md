...
Latest snapshot: **1,810 nodes tracked**, **1,467 active**, **1,442** of those with a responding API. Those 1,442 span **232 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
