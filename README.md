...
Latest snapshot: **1,896 nodes tracked**, **1,626 active**, **1,596** of those with a responding API. Those 1,596 span **227 autonomous systems**, and **175** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
