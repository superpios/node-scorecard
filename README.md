...
Latest snapshot: **1,618 nodes tracked**, **1,358 active**, **1,329** of those with a responding API. Those 1,329 span **226 autonomous systems**, and **169** (12.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
