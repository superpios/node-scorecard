...
Latest snapshot: **1,637 nodes tracked**, **1,375 active**, **1,343** of those with a responding API. Those 1,343 span **229 autonomous systems**, and **173** (12.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
