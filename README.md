...
Latest snapshot: **1,600 nodes tracked**, **1,333 active**, **1,306** of those with a responding API. Those 1,306 span **225 autonomous systems**, and **173** (13.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
