...
Latest snapshot: **1,585 nodes tracked**, **1,318 active**, **1,283** of those with a responding API. Those 1,283 span **221 autonomous systems**, and **168** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
