...
Latest snapshot: **1,628 nodes tracked**, **1,368 active**, **1,338** of those with a responding API. Those 1,338 span **228 autonomous systems**, and **170** (12.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
