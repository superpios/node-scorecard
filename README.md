...
Latest snapshot: **1,818 nodes tracked**, **1,501 active**, **1,481** of those with a responding API. Those 1,481 span **238 autonomous systems**, and **173** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
