...
Latest snapshot: **1,814 nodes tracked**, **1,468 active**, **1,448** of those with a responding API. Those 1,448 span **233 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
