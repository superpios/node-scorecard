...
Latest snapshot: **1,808 nodes tracked**, **1,491 active**, **1,467** of those with a responding API. Those 1,467 span **233 autonomous systems**, and **168** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
