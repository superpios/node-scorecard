...
Latest snapshot: **2,076 nodes tracked**, **1,635 active**, **1,602** of those with a responding API. Those 1,602 span **228 autonomous systems**, and **173** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
