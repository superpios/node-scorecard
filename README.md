...
Latest snapshot: **1,831 nodes tracked**, **1,462 active**, **1,443** of those with a responding API. Those 1,443 span **232 autonomous systems**, and **157** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
