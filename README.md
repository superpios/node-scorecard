...
Latest snapshot: **1,830 nodes tracked**, **1,520 active**, **1,493** of those with a responding API. Those 1,493 span **246 autonomous systems**, and **178** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
