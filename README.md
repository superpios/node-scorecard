...
Latest snapshot: **1,616 nodes tracked**, **1,357 active**, **1,324** of those with a responding API. Those 1,324 span **224 autonomous systems**, and **172** (13.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
