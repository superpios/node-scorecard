...
Latest snapshot: **1,598 nodes tracked**, **1,335 active**, **1,303** of those with a responding API. Those 1,303 span **224 autonomous systems**, and **175** (13.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
