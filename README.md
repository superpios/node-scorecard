...
Latest snapshot: **1,642 nodes tracked**, **1,372 active**, **1,338** of those with a responding API. Those 1,338 span **225 autonomous systems**, and **173** (12.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
