...
Latest snapshot: **1,599 nodes tracked**, **1,334 active**, **1,305** of those with a responding API. Those 1,305 span **225 autonomous systems**, and **173** (13.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
