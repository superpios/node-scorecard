...
Latest snapshot: **1,811 nodes tracked**, **1,465 active**, **1,443** of those with a responding API. Those 1,443 span **232 autonomous systems**, and **154** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
