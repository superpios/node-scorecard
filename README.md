...
Latest snapshot: **1,833 nodes tracked**, **1,499 active**, **1,474** of those with a responding API. Those 1,474 span **244 autonomous systems**, and **178** (12.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
