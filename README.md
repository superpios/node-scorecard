...
Latest snapshot: **1,804 nodes tracked**, **1,485 active**, **1,464** of those with a responding API. Those 1,464 span **230 autonomous systems**, and **164** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
