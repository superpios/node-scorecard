...
Latest snapshot: **1,585 nodes tracked**, **1,320 active**, **1,288** of those with a responding API. Those 1,288 span **222 autonomous systems**, and **169** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
