...
Latest snapshot: **1,832 nodes tracked**, **1,465 active**, **1,438** of those with a responding API. Those 1,438 span **232 autonomous systems**, and **154** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
