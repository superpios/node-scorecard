...
Latest snapshot: **1,838 nodes tracked**, **1,476 active**, **1,454** of those with a responding API. Those 1,454 span **238 autonomous systems**, and **158** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
