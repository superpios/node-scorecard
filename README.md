...
Latest snapshot: **1,821 nodes tracked**, **1,467 active**, **1,445** of those with a responding API. Those 1,445 span **233 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
