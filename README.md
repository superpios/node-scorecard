...
Latest snapshot: **1,638 nodes tracked**, **1,374 active**, **1,341** of those with a responding API. Those 1,341 span **228 autonomous systems**, and **172** (12.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
