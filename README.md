...
Latest snapshot: **1,593 nodes tracked**, **1,331 active**, **1,304** of those with a responding API. Those 1,304 span **224 autonomous systems**, and **171** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
