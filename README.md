...
Latest snapshot: **1,829 nodes tracked**, **1,466 active**, **1,423** of those with a responding API. Those 1,423 span **233 autonomous systems**, and **156** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
