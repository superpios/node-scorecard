...
Latest snapshot: **1,816 nodes tracked**, **1,546 active**, **1,513** of those with a responding API. Those 1,513 span **225 autonomous systems**, and **174** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
