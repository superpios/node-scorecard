...
Latest snapshot: **1,818 nodes tracked**, **1,503 active**, **1,483** of those with a responding API. Those 1,483 span **238 autonomous systems**, and **172** (11.6%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
