...
Latest snapshot: **1,818 nodes tracked**, **1,493 active**, **1,473** of those with a responding API. Those 1,473 span **237 autonomous systems**, and **178** (12.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
