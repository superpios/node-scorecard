...
Latest snapshot: **1,830 nodes tracked**, **1,470 active**, **1,422** of those with a responding API. Those 1,422 span **234 autonomous systems**, and **157** (11.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
