...
Latest snapshot: **1,809 nodes tracked**, **1,496 active**, **1,473** of those with a responding API. Those 1,473 span **233 autonomous systems**, and **165** (11.2%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
