...
Latest snapshot: **1,828 nodes tracked**, **1,516 active**, **1,492** of those with a responding API. Those 1,492 span **246 autonomous systems**, and **178** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
