...
Latest snapshot: **1,832 nodes tracked**, **1,495 active**, **1,467** of those with a responding API. Those 1,467 span **241 autonomous systems**, and **176** (12.0%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
