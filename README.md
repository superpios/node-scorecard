...
Latest snapshot: **1,820 nodes tracked**, **1,468 active**, **1,442** of those with a responding API. Those 1,442 span **234 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
