...
Latest snapshot: **1,615 nodes tracked**, **1,361 active**, **1,326** of those with a responding API. Those 1,326 span **226 autonomous systems**, and **169** (12.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
