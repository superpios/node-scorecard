...
Latest snapshot: **1,810 nodes tracked**, **1,499 active**, **1,470** of those with a responding API. Those 1,470 span **229 autonomous systems**, and **175** (11.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
