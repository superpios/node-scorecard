...
Latest snapshot: **1,588 nodes tracked**, **1,330 active**, **1,301** of those with a responding API. Those 1,301 span **223 autonomous systems**, and **167** (12.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
