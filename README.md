...
Latest snapshot: **1,832 nodes tracked**, **1,461 active**, **1,439** of those with a responding API. Those 1,439 span **230 autonomous systems**, and **154** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
