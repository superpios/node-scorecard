...
Latest snapshot: **1,828 nodes tracked**, **1,525 active**, **1,499** of those with a responding API. Those 1,499 span **246 autonomous systems**, and **176** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
