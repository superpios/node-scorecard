...
Latest snapshot: **2,344 nodes tracked**, **1,733 active**, **1,698** of those with a responding API. Those 1,698 span **231 autonomous systems**, and **175** (10.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
