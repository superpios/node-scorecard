...
Latest snapshot: **1,820 nodes tracked**, **1,492 active**, **1,473** of those with a responding API. Those 1,473 span **239 autonomous systems**, and **178** (12.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
