...
Latest snapshot: **1,830 nodes tracked**, **1,468 active**, **1,441** of those with a responding API. Those 1,441 span **233 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
