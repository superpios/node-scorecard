...
Latest snapshot: **2,342 nodes tracked**, **1,731 active**, **1,697** of those with a responding API. Those 1,697 span **231 autonomous systems**, and **177** (10.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
