...
Latest snapshot: **1,832 nodes tracked**, **1,469 active**, **1,442** of those with a responding API. Those 1,442 span **233 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
