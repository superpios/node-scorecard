...
Latest snapshot: **1,808 nodes tracked**, **1,493 active**, **1,472** of those with a responding API. Those 1,472 span **231 autonomous systems**, and **168** (11.4%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
