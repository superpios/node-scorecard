...
Latest snapshot: **1,830 nodes tracked**, **1,521 active**, **1,492** of those with a responding API. Those 1,492 span **247 autonomous systems**, and **176** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
