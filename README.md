...
Latest snapshot: **1,816 nodes tracked**, **1,545 active**, **1,514** of those with a responding API. Those 1,514 span **226 autonomous systems**, and **174** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
