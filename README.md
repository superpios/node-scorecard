...
Latest snapshot: **1,820 nodes tracked**, **1,488 active**, **1,467** of those with a responding API. Those 1,467 span **237 autonomous systems**, and **172** (11.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
