...
Latest snapshot: **1,600 nodes tracked**, **1,336 active**, **1,297** of those with a responding API. Those 1,297 span **225 autonomous systems**, and **173** (13.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
