...
Latest snapshot: **1,617 nodes tracked**, **1,361 active**, **1,335** of those with a responding API. Those 1,335 span **225 autonomous systems**, and **172** (12.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
