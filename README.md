...
Latest snapshot: **1,837 nodes tracked**, **1,476 active**, **1,452** of those with a responding API. Those 1,452 span **237 autonomous systems**, and **157** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
