...
Latest snapshot: **1,817 nodes tracked**, **1,555 active**, **1,520** of those with a responding API. Those 1,520 span **225 autonomous systems**, and **175** (11.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
