...
Latest snapshot: **1,825 nodes tracked**, **1,466 active**, **1,448** of those with a responding API. Those 1,448 span **235 autonomous systems**, and **158** (10.9%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
