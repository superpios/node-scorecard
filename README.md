...
Latest snapshot: **1,804 nodes tracked**, **1,487 active**, **1,465** of those with a responding API. Those 1,465 span **231 autonomous systems**, and **165** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
