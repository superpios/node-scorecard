...
Latest snapshot: **1,810 nodes tracked**, **1,497 active**, **1,463** of those with a responding API. Those 1,463 span **230 autonomous systems**, and **173** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
