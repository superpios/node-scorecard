...
Latest snapshot: **1,833 nodes tracked**, **1,480 active**, **1,452** of those with a responding API. Those 1,452 span **233 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
