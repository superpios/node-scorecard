...
Latest snapshot: **1,586 nodes tracked**, **1,330 active**, **1,290** of those with a responding API. Those 1,290 span **223 autonomous systems**, and **169** (13.1%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
