...
Latest snapshot: **1,810 nodes tracked**, **1,497 active**, **1,473** of those with a responding API. Those 1,473 span **229 autonomous systems**, and **174** (11.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
