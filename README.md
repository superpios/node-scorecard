...
Latest snapshot: **1,812 nodes tracked**, **1,470 active**, **1,446** of those with a responding API. Those 1,446 span **234 autonomous systems**, and **155** (10.7%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
