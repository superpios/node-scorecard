...
Latest snapshot: **2,077 nodes tracked**, **1,537 active**, **1,503** of those with a responding API. Those 1,503 span **229 autonomous systems**, and **170** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
