...
Latest snapshot: **2,341 nodes tracked**, **1,732 active**, **1,696** of those with a responding API. Those 1,696 span **230 autonomous systems**, and **175** (10.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
