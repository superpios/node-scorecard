...
Latest snapshot: **2,341 nodes tracked**, **1,733 active**, **1,700** of those with a responding API. Those 1,700 span **231 autonomous systems**, and **179** (10.5%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
