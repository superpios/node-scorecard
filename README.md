...
Latest snapshot: **1,829 nodes tracked**, **1,459 active**, **1,440** of those with a responding API. Those 1,440 span **230 autonomous systems**, and **156** (10.8%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
