...
Latest snapshot: **1,804 nodes tracked**, **1,485 active**, **1,463** of those with a responding API. Those 1,463 span **229 autonomous systems**, and **166** (11.3%) pass verified-residential checks (geo-IP flag *and* a non-hosting ASN).
